...
head:
  ...
  - tag: meta
    attrs:
      name: go-source
      content: 'dappco.re/go/inference https://github.com/dappcore/go-inference https://github.com/dappcore/go-inference/tree/main/go{/dir} https://github.com/dappcore/go-inference/blob/main/go{/dir}/{file}#L{line}'
---
