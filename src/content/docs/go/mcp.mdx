...
head:
  - tag: meta
    attrs:
      name: go-import
      content: 'dappco.re/go/mcp git https://github.com/dappcore/mcp.git go'
  - tag: meta
    attrs:
      name: go-source
      content: 'dappco.re/go/mcp https://github.com/dappcore/mcp https://github.com/dappcore/mcp/tree/main/go{/dir} https://github.com/dappcore/mcp/blob/main/go{/dir}/{file}#L{line}'
---
