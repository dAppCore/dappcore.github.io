...
head:
  ...
  - tag: meta
    attrs:
      name: go-source
      content: 'dappco.re/go/io https://github.com/dappcore/go-io https://github.com/dappcore/go-io/tree/main/go{/dir} https://github.com/dappcore/go-io/blob/main/go{/dir}/{file}#L{line}'
---
