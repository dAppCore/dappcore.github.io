...
head:
  - tag: meta
    attrs:
      name: go-import
      content: 'dappco.re/go/miner git https://github.com/dappcore/go-miner.git go'
  - tag: meta
    attrs:
      name: go-source
      content: 'dappco.re/go/miner https://github.com/dappcore/go-miner https://github.com/dappcore/go-miner/tree/main/go{/dir} https://github.com/dappcore/go-miner/blob/main/go{/dir}/{file}#L{line}'
---
