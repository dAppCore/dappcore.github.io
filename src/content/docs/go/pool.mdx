...
head:
  - tag: meta
    attrs:
      name: go-import
      content: 'dappco.re/go/pool git https://github.com/dappcore/go-pool.git go'
  - tag: meta
    attrs:
      name: go-source
      content: 'dappco.re/go/pool https://github.com/dappcore/go-pool https://github.com/dappcore/go-pool/tree/main/go{/dir} https://github.com/dappcore/go-pool/blob/main/go{/dir}/{file}#L{line}'
---
