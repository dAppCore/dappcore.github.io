...
head:
  ...
  - tag: meta
    attrs:
      name: go-source
      content: 'dappco.re/go/ml https://github.com/dappcore/go-ml https://github.com/dappcore/go-ml/tree/main/go{/dir} https://github.com/dappcore/go-ml/blob/main/go{/dir}/{file}#L{line}'
---
