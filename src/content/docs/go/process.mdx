...
head:
  ...
  - tag: meta
    attrs:
      name: go-source
      content: 'dappco.re/go/process https://github.com/dappcore/go-process https://github.com/dappcore/go-process/tree/main/go{/dir} https://github.com/dappcore/go-process/blob/main/go{/dir}/{file}#L{line}'
---
