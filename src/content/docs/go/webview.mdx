...
head:
  - tag: meta
    attrs:
      name: go-import
      content: 'dappco.re/go/webview git https://github.com/dappcore/go-webview.git go'
  - tag: meta
    attrs:
      name: go-source
      content: 'dappco.re/go/webview https://github.com/dappcore/go-webview https://github.com/dappcore/go-webview/tree/main/go{/dir} https://github.com/dappcore/go-webview/blob/main/go{/dir}/{file}#L{line}'
---
