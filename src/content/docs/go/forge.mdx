...
head:
  - tag: meta
    attrs:
      name: go-import
      content: 'dappco.re/go/forge git https://github.com/dappcore/go-forge.git go'
  - tag: meta
    attrs:
      name: go-source
      content: 'dappco.re/go/forge https://github.com/dappcore/go-forge https://github.com/dappcore/go-forge/tree/main/go{/dir} https://github.com/dappcore/go-forge/blob/main/go{/dir}/{file}#L{line}'
---
